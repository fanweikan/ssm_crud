...
<script src="${APP_PATH}/static/bootstrap-3.3.7-dist/js/jquery-1.9.1.js"></script>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<!-- 分页文字信息 -->
			<div class="col-md-6" id="page_info_area">当前第页,总页,总共有条记录</div>
			<!-- 分页条信息 -->
	...
	<script type="text/javascript">
		...
		$(document).on("click", ".delete_btn", function() {
			//弹出是否删除对话框
			var del_idstr = $(this).parents("tr").find("td:eq(1)").text();
